...
//  AI_Farming
//
//  Created by yuankai on 2019/12/25.
...
+ (BOOL)isIntersectByCoorLine1:(NSArray *)line1 line2:(NSArray *)line2{
    CLLocationCoordinate2D p0 = [self coordinate:line1.firstObject];
    CLLocationCoordinate2D p1 = [self coordinate:line1.lastObject];
    CLLocationCoordinate2D q0 = [self coordinate:line2.firstObject];
    CLLocationCoordinate2D q1 = [self coordinate:line2.lastObject];
