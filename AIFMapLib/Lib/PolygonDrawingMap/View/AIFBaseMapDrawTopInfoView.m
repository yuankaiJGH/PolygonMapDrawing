...
- (UIButton *)confirmBtn{
    if (!_confirmBtn) {
        ...
        [button setBackgroundImage:[UIConfig imageWithColor:SAMERGB(137)] forState:UIControlStateDisabled];
        [button setBackgroundImage:[UIConfig imageWithColor:THEMECOLOR] forState:UIControlStateNormal];
